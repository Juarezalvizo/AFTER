const token = 'TOKEN_DE_ACCESO'; // Reemplaza esto con tu token de acceso

fetch('https://www.googleapis.com/calendar/v3/calendars/MI_CALENDARIO/events', {
  headers: {
...
.then(data => {
  console.log(data); // Aquí se mostrarán los datos del calendario
})
.catch(error => {
  console.error(error);
});
